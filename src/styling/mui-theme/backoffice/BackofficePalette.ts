import { backofficeLightColorTokens, backofficeDarkColorTokens } from "./BackofficeColorTokens";

export const lightColorTokens = backofficeLightColorTokens;

export const lightBackofficePalette = {
    primary: {
...
export const darkColorTokens = backofficeDarkColorTokens;

export const darkBackofficePalette = {
    primary: {
